...
import epicgames from '../assets/img/arcadeclub.gif'
  ...
  return (
    <div className="help">
      ...
      <section className="search">
        ...
        <div className="help-gallery py-5">
          <div className="container">
            ...
            <div class="card text-white col-lg-16 col-md-6 img-hover-zoom img-hover-zoom--basic">
        <img src={fortinite} class="card-img" alt="..."/>
        <hr />
         <div class="card-img-overlay d-flex align-items-end justify-content-between">
    
      
       <a href="/" className='text-light'><p class="card-text text-start ">ARCADE</p></a>
      ...
      <div class="card text-white col-lg-6 col-md-6 img-hover-zoom img-hover-zoom--basic">
       ...
       <a href="/" className='text-light'><p class="card-text text-start ">ARCADE CLUB STORE</p></a>
       <i class="fa-solid fa-arrow-right"></i>
